...
- Maybe we should look into how auth0 does its access management. Like do they give developers the ability to write custom roles and rules for users in the provided SDK?
